...
def main():
    if (len(sys.argv) == 3):
        ...
        print("Creating graphic FreeEnergyXheight.pdf")
        ...
        ax.text(50,1, "(d)", fontsize = 40)
#        ax.legend(loc='upper left', markerscale=0.8, borderpad = 0.2,labelspacing=0.3, handlelength=0.5 )
        plt.tight_layout()
        plt.savefig("./analysis/graphicsThermodynamic/FreeEnergyTotXheight.pdf")
        plt.close()
    else:
